...
const MeetingRecorder = () => {
  ...
  const transcribeAudio = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://43.203.161.30:8000/api/transcribe', formData, {
        headers: {
  ...
  const generateSummary = async () => {
    ...
    setIsProcessing(true)
    try {
      const response = await axios.post('http://43.203.161.30:8000/api/summarize', {
        ...
        {summary && (
          <div className="summary-section">
            ...
            <div className="action-buttons">
              <a
                href={`http://43.203.161.30:8000/api/meetings/${summary.id}/export/pdf`}
                className="btn btn-secondary"
                download
              >
                📄 PDF 다운로드
              ...
              <a
                href={`http://43.203.161.30:8000/api/meetings/${summary.id}/export/docx`}
                className="btn btn-secondary"
                download
              >
                📝 Word 다운로드
