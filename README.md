...
**한 줄 요약: 회의 내용을 자동으로 기록하고, 요약까지 대신하는 AI 비서**
...
- 회의 종료 후 GPT가 핵심 내용, 결론, 액션 아이템을 자동 요약  
- 수동 기록 및 정리 시간을 90% 이상 절감하여,  **“회의는 말로, 기록은 AI가** 실현 
...
| **텍스트 정제 및 화자 구분** | 음성 내 화자 자동 식별(Diarization), 불필요한 구절 제거 |
| **AI 자동 요약 기능** | GPT가 회의 내용 요약 및 액션 포인트 도출 |
| **회의록 형식 변환** | 텍스트, PDF, Word, Notion 등 다양한 포맷으로 자동 내보내기 |
